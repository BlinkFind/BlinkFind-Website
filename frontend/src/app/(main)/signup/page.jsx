      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-lg sm:rounded-lg sm:px-10">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="confirm-password" className="block text-sm font-medium text-[#130F26]">
                Confirm Password
              </label>
              <div className="mt-1 relative rounded-md shadow-sm">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          ...
          <p className="mt-6 text-center text-sm text-[#4A5568]">
            ...
            <Link href="/login" className="font-medium text-[#51B504] hover:text-[#45A003] transition-colors duration-300">
              Sign in
            </Link>
          </p>
        </div>
